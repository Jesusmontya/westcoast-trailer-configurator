...
const translations = {
  en: {
    ...
    advantages: {
      ...
      items: [
        { question: "", title: "Flexible Financing", text: "Get started without paying everything upfront." },
        { question: "", title: "Fast Turnaround", text: "Efficient production to get your business moving sooner." },
        { question: "", title: "Fully Custom Design", text: "Built around your menu, equipment and workflow." },
        { question: "", title: "Structural Warranty", text: "Coverage backed by our build quality and craftsmanship." },
        { question: "", title: "Commercial-Grade Equipment", text: "Professional equipment made for real daily volume." },
        { question: "", title: "Accessible Pricing", text: "Quality builds designed around real small-business budgets." },
      ],
    },
  ...
  es: {
    ...
    advantages: {
      ...
      items: [
        { question: "", title: "Financiamiento flexible", text: "Empieza sin tener que pagar todo por adelantado." },
        { question: "", title: "Entrega rápida", text: "Producción eficiente para poner tu negocio en marcha antes." },
        { question: "", title: "Diseño 100% personalizado", text: "Construido alrededor de tu menú, equipo y forma de trabajar." },
        { question: "", title: "Garantía estructural", text: "Respaldada por nuestra calidad de construcción y trabajo." },
        { question: "", title: "Equipo de calidad comercial", text: "Equipo profesional hecho para el volumen diario real." },
        { question: "", title: "Precios accesibles", text: "Calidad pensada para presupuestos reales de pequeños negocios." },
      ],
    },
